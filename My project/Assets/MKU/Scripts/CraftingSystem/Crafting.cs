...
namespace MKU.Scripts.CraftingSystem
{
    public class Crafting : MonoBehaviour
    {
        ...
        private void Start()
        {
            Singleton.Instance._crafting = this;
        }

        public static Crafting GetPlayerInventory(Transform player)
        => CharSettings._Instance._charController.GetComponent<Crafting>();
