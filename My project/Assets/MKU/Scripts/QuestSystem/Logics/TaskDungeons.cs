...
{
    public class TaskDungeons : BaseController, ITaskController
    {
        public TaskCondition requestCode = TaskCondition.Dungeons;
        Objective _quest;
        public TaskDungeons(Objective quest) => _quest = quest;
